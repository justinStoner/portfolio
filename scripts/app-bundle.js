define('about',['exports', 'chartjs'], function (exports, _chartjs) {
  ...
  var About = exports.About = function () {
    function About() {
      ...
      this.labels = ['Javascript', 'HTML', 'CSS', 'Aurelia', 'Angular', 'React', 'Node', 'Express', 'PHP'], this.values = [95, 90, 90, 100, 80, 60, 85, 80, 70];
      this.skills = [{
        name: 'Javascript',
        value: 95,
    ...
    About.prototype.attached = function attached() {
      ...
      this.chart = new _chartjs2.default(canvas, {
        type: 'polarArea',
        data: {
          datasets: [{
            data: this.values,
...
define('showcases/beatmaker/sequencer/sequencer',["exports", "aurelia-framework", "aurelia-fetch-client", "../components/audio-bus", "aurelia-event-aggregator"], function (exports, _aureliaFramework, _aureliaFetchClient, _audioBus, _aureliaEventAggregator) {
  ...
  var SequencerCustomElement = exports.SequencerCustomElement = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _audioBus.AudioBus, _aureliaEventAggregator.EventAggregator), _dec(_class = (_class2 = function () {

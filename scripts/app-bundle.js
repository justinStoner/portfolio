  ...
  var SynthService = exports.SynthService = (_dec = (0, _aureliaFramework.inject)(_audioBus.AudioBus, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    ...
    SynthService.prototype.createSubs = function createSubs() {
      ...
      this.ea.subscribe('lfowave', function (msg) {
        _this.lfoData.wave = msg;
        for (var i = 0; i < _this.notes.length; i++) {
          try {
            _this.notes[i].lfo.type = _this.waves[_this.lfoData.wave === 0.1 ? 0 : _this.lfoData.wave];
          } catch (e) {}
        }
      });
      ...
      this.ea.subscribe('osc-wave1', function (msg) {
        _this.oscillators[0].wave = msg;
        for (var i = 0; i < _this.notes.length; i++) {
          try {
            _this.notes[i]['o0'].type = _this.waves[msg];
          } catch (e) {}
        }
      });
      ...
      this.ea.subscribe('osc-wave2', function (msg) {
        _this.oscillators[1].wave = msg;
        for (var i = 0; i < _this.notes.length; i++) {
          try {
            _this.notes[i].o1.type = _this.waves[msg];
          } catch (e) {}
        }
      });
      ...
      this.ea.subscribe('osc-wave3', function (msg) {
        _this.oscillators[2].wave = msg;
        for (var i = 0; i < _this.notes.length; i++) {
          try {
            _this.notes[i].o2.type = _this.waves[msg];
          } catch (e) {}
        }
      });
      ...
      this.ea.subscribe('toggleCompressor:synth', function (msg) {
        ...
        if (_this.compressionOn) {
          if (_this.delayOn) {
            ...
            _this.effectsIn.connec(_this.compressor);
          }
          ...
          if (_this.delayOn) {
            ...
            _this.effectsIn.disconnect();
            _this.effectsIn.connec(_this.effectsOut);
          }
        }
      });
...
define('resources/elements/side-nav/side-nav',['exports', 'aurelia-framework', '../../../app-router', '../../../services/drum-service', '../../../showcases/beatmaker/components/audio-bus'], function (exports, _aureliaFramework, _appRouter, _drumService, _audioBus) {
  ...
  var SideNav = exports.SideNav = (_dec = (0, _aureliaFramework.inject)(_appRouter.AppRouter, _drumService.DrumService, _audioBus.AudioBus), _dec(_class = function SideNav(appRouter, ds, ab) {
...
define('text!showcases/beatmaker/components/slider.html', ['module'], function(module) { module.exports = "<template><div class=\"mdl-color--blue-500 mdl-color-text--white center-align b-radius-card\" css=\"margin-bottom:12px;display:inline-block;vertical-align:middle;padding:0px;text-align:center;${channel==='tempo'?'':'width:100%;padding-left:5px;'}\"><div class=\"\" style=float:left><p class=slider-label>${label}</p><input class=\"mdl-textfield__input text-center\" type=number change.delegate=change() value.bind=val style=\"margin-top:6px;margin-bottom:6px;margin-right:auto;margin-left:auto;display:block;width:30px;border-bottom:1px solid #fff\"></div><div style=float:right><button class=\"mdl-button mdl-js-button mdl-button--icon\" style=display:block click.delegate=add()><i class=material-icons>add</i></button><button class=\"mdl-button mdl-js-button mdl-button--icon\" click.delegate=minus()><i class=material-icons>remove</i></button></div></div><p style=margin-bottom:0 if.bind=noSlider><input class=\"mdl-slider mdl-js-slider\" type=range id=s1 min=${min} max=${max} value.bind=val step=1></p></template>"; });
...
define('text!showcases/beatmaker/effects/compressor.html', ['module'], function(module) { module.exports = "<template><require from=../components/knob></require><require from=../components/slider></require><require from=../components/switch></require><div class=\"mdl-shadow--2dp b-radius-card mdl-color--blue-grey-100\"><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>${mode=='sidechain'?'Sidechain ':''}Compressor<switch class=right switched.two-way=comp[mode].active click.delegate=toggleEffect()></switch></p></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><slider min=0 max=100 label=Attack val.two-way=comp[mode].attack inline.bind=true channel=compAttack:${mode} preset.one-time=comp[mode].attack></slider></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><slider min=0 max=100 label=Thrsh. val.two-way=comp[mode].threshold inline.bind=true channel=compThresh:${mode} preset.one-time=comp[mode].threshold></slider></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><slider min=1 max=20 label=Ratio val.two-way=comp[mode].ratio inline.bind=true channel=compRatio:${mode} preset.one-time=comp[mode].ratio></slider></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><slider min=0 max=100 label=Rls. val.two-way=comp[mode].release inline.bind=true channel=compRelease:${mode} preset.one-time=comp[mode].release></slider></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><slider min=0 max=40 label=Knee val.two-way=comp[mode].knee inline.bind=true channel=compKnee:${mode} preset.one-time=comp[mode].knee></slider></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--3-col-phone mdl-cell--2-col-tablet\" if.bind=\"mode==='sidechain'\"><label for=\"\" style=position:relative;top:0>Source</label><select name=\"\" id=\"\" class=mdl-textfield__input disabled style=\"background:0 0\"><option value=kick selected>kick</option></select></div></div></div></template>"; });
define('text!showcases/beatmaker/effects/delay.html', ['module'], function(module) { module.exports = "<template><require from=../components/knob></require><require from=../components/switch></require><div class=\"mdl-shadow--2dp b-radius-card mdl-color--lime-400\"><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>Delay<switch class=right switched.two-way=ds[mode].active click.delegate=toggleEffect()></switch></p></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Time val.two-way=ds[mode].dTime channel=delayTime preset.one-time=ds[mode].dTime></knob></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Feedback val.two-way=ds[mode].dFeed channel=delayFeedback preset.one-time=ds[mode].dFeed></knob></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Wet/Dry val.two-way=ds[mode].dWet channel=delayWet preset.one-time=ds[mode].dWet></knob></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"></div></div></div></template>"; });
define('text!showcases/beatmaker/effects/equalizer.html', ['module'], function(module) { module.exports = "<template><require from=../components/knob></require><require from=../components/switch></require><div class=\"mdl-shadow--2dp b-radius-card mdl-color--red-300\"><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>Equalizer<switch class=right switched.two-way=eq[mode].active click.delegate=toggleEffect()></switch></p></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=80 label=80hz val.two-way=eq[mode].eq1 channel=eq1 preset.one-time=eq[mode].eq1></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=80 label=350hz val.two-way=eq[mode].eq2 channel=eq2 preset.one-time=eq[mode].eq2></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=80 label=720hz val.two-way=eq[mode].eq3 channel=eq3 preset.one-time=eq[mode].eq3></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=80 label=1.6khz val.two-way=eq[mode].eq4 channel=eq4 preset.one-time=eq[mode].eq4></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=80 label=5khz val.two-way=eq[mode].eq5 channel=eq5 preset.one-time=eq[mode].eq5></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=80 label=10khz val.two-way=eq[mode].eq6 channel=eq6 preset.one-time=eq[mode].eq6></knob></div></div></div></template>"; });
define('text!showcases/beatmaker/sequencer/sequencer.html', ['module'], function(module) { module.exports = "<template><require from=../components/sound-wave></require><require from=./styles/sequencer.css></require><require from=../components/knob></require><require from=../components/sound-wave></require><require from=../components/slider></require><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col\"><div class=\"b-radius-card mdl-color--blue-500 mdl-shadow--2dp\" id=sequencer-controller><div class=mdl-grid><div class=\"mdl-cell mdl-cell--2-col mdl-cell--2-col-tablet mdl-cell--2-col-phone\" style=padding-top:27px><button class=\"mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect ${!mixer?'mdl-color-text--white':'mdl-color-text--green-A400'} mdl-color--grey-200\" style=margin-right:15px click.delegate=handlePlay()><template if.bind=!ds.playing><i class=\"material-icons mdl-color-text--green-A400\">play_arrow</i></template><template if.bind=ds.playing><i class=\"material-icons mdl-color-text--red-500\">stop</i></template></button><button class=\"mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect ${!mixer?'mdl-color-text--grey-400':'mdl-color-text--green-A400'} mdl-color--grey-200\" click.delegate=toggleMixer()><i class=material-icons>equalizer</i></button></div><div class=\"mdl-cell mdl-cell--1-col mdl-cell--2-col-tablet mdl-cell--1-col-phone\"><knob min=0 max=100 label=Volume canvas.bind=true preset.one-time=volume val.two-way=ds.volume></knob></div><div class=\"mdl-cell mdl-cell--2-col mdl-cell--4-col-tablet mdl-cell--1-col-phone\"><slider min=0 max=220 label=Tempo val.two-way=ds.tempo inline.bind=true no-slider=true channel=tempo preset=120></slider></div></div></div></div><div class=\"mdl-cell mdl-cell--12-col\"><table class=striped id=sequencer-notes><thead style=border-bottom:0><tr><td style=width:5.88%></td><td repeat.for=\"i of 16\" style=width:5.88%><div class=\"${ds.notePlaying-1==i?'mdl-color--blue-300':'mdl-color--white'} lighten-2\" style=height:5px></div></td></tr></thead><tbody if.bind=!mixer><tr repeat.for=\"drum of ds.drums\"><td style=width:5.88%;cursor:pointer;height:36px class=mdl-color-text--blue-500 click.trigger=playSample(drum.sound)>${drum.name}</td><td class=\"${ds.scheduled[$parent.$index][i]==true?'mdl-color--blue-500':'mdl-color--green-A400'}\" repeat.for=\"i of 16\" style=\"width:5.88%;border-left:1px solid #fff;border-bottom:1px solid #fff;min-height:36px;cursor:pointer\" click.trigger=\"addNote($event, $parent.$index, i)\"></td></tr></tbody></table><table class=striped if.bind=mixer id=sequencer-mixer><tbody><tr repeat.for=\"drum of ds.drums\"><td style=width:5.88%;cursor:pointer class=blue-text click.trigger=playSample(drum.sound)>${drum.name}</td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=80 label=Volume preset.one-time=drum.volume val.two-way=drum.volume></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=80 label=Pitch preset.one-time=drum.volume val.two-way=drum.pitch></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=80 label=High preset.one-time=drum.high val.two-way=drum.high></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min.one-time=drum.range.high[0] max.one-time=drum.range.high[1] label=\"High Freq\" preset.one-time=drum.highFreq val.two-way=drum.highFreq></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=80 label=Mid preset.one-time=drum.mid val.two-way=drum.mid></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min.one-time=drum.range.mid[0] max.one-time=drum.range.mid[1] label=\"Mid Freq\" preset.one-time=drum.midFreq val.two-way=drum.midFreq></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=80 label=Low preset.one-time=drum.low val.two-way=drum.low></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min.one-time=drum.range.low[0] max.one-time=drum.range.low[1] label=\"Low Freq\" preset.one-time=drum.lowFreq val.two-way=drum.lowFreq></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=200 label=Cutoff preset.one-time=drum.cutoff val.two-way=drum.cutoff></knob></div></td><td><div class=\"input-field inline\" style=margin-top:0><knob min=0 max=20 label=Q preset.one-time=drum.Q val.two-way=drum.Q></knob></div></td><td><div class=\"input-field inline\" style=\"\"><label for=\"\" style=position:relative;top:0>Filter Type</label><select name=\"\" id=\"\" class=browser-default value.bind=drum.filterType><option value=lowpass>lowpass</option><option value=highpass>highpass</option><option value=bandpass>bandpass</option><option value=lowshelf>lowshelf</option><option value=highshelf>highshelf</option><option value=peaking>peaking</option><option value=notch>notch</option><option value=allpass>allpass</option></select></div></td></tr></tbody></table></div></div></template>"; });
define('text!showcases/beatmaker/synth/piano.html', ['module'], function(module) { module.exports = "<template><require from=./components/piano-key></require><require from=../components/sound-wave></require><require from=../components/mute-button></require><require from=../components/knob></require><require from=./styles/synth.css></require><require from=./components/oscillator></require><require from=../effects/compressor></require><require from=../effects/delay></require><require from=../effects/equalizer></require><div class=synth-container><div class=effects-container><div><div class=mdl-grid><div class=\"mdl-cell mdl-cell--3-col mdl-cell--12-col-phone mdl-cell--8-col-tablet\"><oscillator type=Lfo osc.two-way=synth.lfoData preset.one-time=synth.lfoData></oscillator></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--12-col-phone mdl-cell--8-col-tablet\" repeat.for=\"osc of synth.oscillators\"><oscillator osc.two-way=osc index.bind=$index type=Oscillator preset.one-time=synth.oscPresets[$index]></oscillator></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--12-col-phone mdl-cell--4-col-tablet\"><div id=filter class=\"mdl-shadow--2dp mdl-color--orange-300 b-radius-card\"><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>Filter</p></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=200 label=Cutoff preset.one-time=synth.lpfCutoff channel=lpfCutoff></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=20 label=Q channel=lpfQ preset.one-time=synth.lpfQ></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Mod channel=lpfMod preset.one-time=synth.lpfMod></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Env val.two-way=synth.lpfEnv preset.one-time=synth.lpfEnv></knob></div><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=\"no-bottom-margin no-bottom-margin\">Envelope</p></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Attack val.two-way=synth.lpfA preset.one-time=synth.lpfA></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Decay val.two-way=synth.lpfD preset.one-time=synth.lpfD></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Sustain val.two-way=synth.lpfS preset.one-time=lsynth.pfS></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Release val.two-way=synth.lpfR preset.one-time=synth.lpfR></knob></div></div></div></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--12-col-phone mdl-cell--4-col-tablet\" id=synth><div id=synthfilter class=\"mdl-shadow--2dp b-radius-card\"><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin style=float:left>Synth</p><div class=synth-octave>Octave: ${synth.synthOctave}<button class=\"mdl-button mdl-js-button mdl-button--icon\" style=\"\" click.delegate=\"synth.changeSynthOctave('up')\"><i class=material-icons>add</i></button><button class=\"mdl-button mdl-js-button mdl-button--icon\" click.delegate=\"synth.changeSynthOctave('down')\"><i class=material-icons>remove</i></button></div></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Drive val.two-way=synth.lpfA canvas.bind=true preset.one-time=synth.lpfA></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Reverb val.two-way=synth.lpfD canvas.bind=true preset.one-time=synth.lpfA></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob id=soundwave min=0 max=100 label=Volume canvas.bind=true channel=synthvol preset.one-time=synth.masterVol></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet text-center\"><p style=margin-bottom:6px>Visualizer</p><button class=\"mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect ${ab.showVisualizer?'mdl-color-text--green-A400 mdl-color--white':'mdl-color--green-A400 mdl-color-text--white'}\" click.trigger=\"ab.showVisualizer=!ab.showVisualizer\" id=visualizer><i class=material-icons>graphic_eq</i></button></div><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>Envelope</p></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Attack canvas.bind=true val.two-way=synth.envA preset.one-time=synth.envA></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Decay canvas.bind=true val.two-way=synth.envD preset.one-time=synth.envD></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Sustain canvas.bind=true val.two-way=synth.envS preset.one-time=synth.envS></knob></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Release canvas.bind=true val.two-way=synth.envR preset.one-time=synth.envR></knob></div></div></div><sound-wave ab.bind=ab canvas-id=synthfilter if.bind=ab.showVisualizer></sound-wave></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--12-col-phone mdl-cell--8-col-tablet\"><equalizer mode=synth></equalizer></div><div class=\"mdl-cell mdl-cell--3-col mdl-cell--12-col-phone mdl-cell--8-col-tablet\"><delay mode=synth></delay></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-cell--8-col-tablet\"><compressor mode=synth></compressor></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-cell--8-col-tablet\"><compressor mode=sidechain></compressor></div></div></div></div><div class=\"key-container mdl-shadow--4dp mdl-color--blue-400 b-radius-card\"><div><piano-key class=\"${note.color?'white'+$index:'black'+$index}\" repeat.for=\"note of synth.notes\" playing.bind=note.isPlaying index.bind=$index assigned.bind=note.assigned key.bind=note containerless></piano-key></div></div></div></template>"; });
define('text!showcases/beatmaker/synth/components/oscillator.html', ['module'], function(module) { module.exports = "<template><require from=../../components/knob></require><require from=../../components/mute-button></require><div class=\"mdl-shadow--2dp b-radius-card ${type==='Lfo'?'mdl-color--deep-orange-400':'mdl-color--blue-grey-100'}\"><template if.bind='type!==\"Lfo\"'><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>${type + ' ' + (index+1)}</p></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Mix val.two-way=osc.volume offset=222 channel=osc-vol${index+1} preset.one-time=preset.volume></knob></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=7 label=Octave labels=-3,-2,-1,0,1,2,3 val.two-way=osc.octave channel=osc-oct${index+1} offset=222 preset.one-time=osc.octave></knob></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=3 label=Wave labels=\"sine, saw, sqr, tri\" val.two-way=osc.wave channel=osc-wave${index+1} offset=276 range=180 preset.one-time=preset.wave></knob></div><div class=\"mdl-cell mdl-cell--6-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Detune val.two-way=osc.detune offset=222 channel=osc-det${index+1} preset.one-time=preset.detune></knob></div></div></template><template if.bind='type===\"Lfo\"'><div class=mdl-grid><div class=\"mdl-cell mdl-cell--12-col no-bottom-margin\"><p class=no-bottom-margin>Lfo</p></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--2-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=20 label=Frequency offset=222 preset.one-time=preset.freq channel=lfofreq></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--2-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=3 label=Wave labels=\"sine, saw, sqr, tri\" preset.one-time=preset.wave channel=lfowave offset=276 range=180></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--2-col-tablet\"><knob min=0 max=100 label=Osc1 val.two-way=osc.osc1 offset=222 preset.one-time=preset.osc1></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--2-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=100 label=Osc2 val.two-way=osc.osc2 offset=222 preset.one-time=preset.osc2></knob></div><div class=\"mdl-cell mdl-cell--4-col mdl-cell--1-col-phone mdl-cell--1-col-tablet\"><knob min=0 max=100 label=Osc3 val.two-way=osc.osc3 offset=222 preset.one-time=preset.osc3></knob></div></div></template></div></template>"; });
